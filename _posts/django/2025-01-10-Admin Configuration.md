...
[![](\assets\posts\2025-01-10-Admin Configuration\admin.png)](\assets\posts\2025-01-10-Admin Configuration\admin.png)
```python
# urls.py
...
[![](\assets\posts\2025-01-10-Admin Configuration\register.png)](\assets\posts\2025-01-10-Admin Configuration\register.png)
[![](\assets\posts\2025-01-10-Admin Configuration\register_author.png)](\assets\posts\2025-01-10-Admin Configuration\register_author.png)
```python
# admin.py
...
[![](\assets\posts\2025-01-10-Admin Configuration\custom.png)](\assets\posts\2025-01-10-Admin Configuration\custom.png)
```python
...
[![](\assets\posts\2025-01-10-Admin Configuration\filter.png)](\assets\posts\2025-01-10-Admin Configuration\filter.png)
```python
...
[![](\assets\posts\2025-01-10-Admin Configuration\action.png)](\assets\posts\2025-01-10-Admin Configuration\action.png)
```python
